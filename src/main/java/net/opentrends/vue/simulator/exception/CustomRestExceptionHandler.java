...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> springHandleNotFound(final AppRuntimeException ex, HttpServletResponse response) throws IOException {		
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
		...
		final ApiError apiError = new ApiError(METHOD_NOT_ALLOWED, ex.getLocalizedMessage(), builder.toString());
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(final HttpMediaTypeNotSupportedException ex,
		...
		final ApiError apiError = new ApiError(UNSUPPORTED_MEDIA_TYPE, ex.getLocalizedMessage(), builder.substring(0, builder.length() - 2));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
